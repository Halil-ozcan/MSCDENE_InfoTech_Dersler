namespace NorthWindManagementApp
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            grpSearch.Controls.Add(rdbContains);
            grpSearch.Controls.Add(rdbWithStart);
            grpSearch.Font = new Font("Segoe UI", 14.2F, FontStyle.Bold);
            grpSearch.ForeColor = Color.RoyalBlue;
            grpSearch.Location = new Point(22, 124);
            grpSearch.Name = "grpSearch";
            grpSearch.Size = new Size(716, 146);
            grpSearch.TabIndex = 8;
            grpSearch.TabStop = false;
            grpSearch.Text = "Gelişmiş Arama";
            // 
            // btnSearch
            // 
            ...
            rdbWithStart.BackColor = SystemColors.Control;
            ...
            rdbWithStart.UseVisualStyleBackColor = false;
            // 
            // btnUpdate
            // 
            ...
            cmbFilterByCategory.SelectedIndexChanged += cmbFilterByCategory_SelectedIndexChanged;
            // 
            // dgwProducts
            // 
